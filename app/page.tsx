        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-extrabold text-black mb-6">Let Us Tell You About Ourselves</h1>
              <p className="text-gray-700 text-base leading-relaxed mb-4">
                Welcome to AOW Information Technology Pvt. Ltd., we are here in this era to transform digital solutions
                for every business. Our result-oriented solutions make the business appealing and stand out from the
                rest. In just two years, we have not only served 83+ clients but are still counting on happy approaches
                from our clients.
              </p>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Having said that the best of our innovative services is to be more creative than any, we wish to be
                  the global leader in expanding our reach to more people with our successful proven results.
                </p>
              </div>
            </div>
          </div>
