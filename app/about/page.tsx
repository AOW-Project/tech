...
const AboutPage = () => {
  return (
    <div className="flex flex-col items-center w-full text-[#000] font-inter">
      ...
      {/* Services Section */}
      <section
        className="w-full flex justify-center py-20 font-[Inter] relative bg-white"
        style={{
          backgroundImage: 'url("/images/bg image.png")',
          backgroundSize: "cover",
          backgroundPosition: "center",
      ...
      <section
        className="w-full py-20 font-[Inter] relative bg-white"
        style={{
          backgroundImage: 'url("/images/bg image.png")',
          backgroundSize: "cover",
          backgroundPosition: "center",
              ...
              <div className="text-left">
                <div className="flex items-start gap-2">
                  <blockquote className="text-base text-black leading-relaxed max-w-2xl">
                    We absolutely loved working with this team! The Skill Kiwi site turned out even better than we
                    imagined — fun, modern, and super engaging. Huge thanks for bringing our vision to life! The UI is
                ...
                <div className="flex items-center gap-3 mt-6">
                  <img src="/images/client logo.png" alt="Client company logo" className="w-8 h-8 object-contain" />
                  <p className="text-sm text-black font-semibold">Alice Rosenberg, co-owner</p>
