  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 2:
        return (
          <div>
            <h2 className="text-[#1b8bf9] text-2xl font-bold mb-6">GOT A VISION OR IDEA? LETS TURN IT INTO REALITY</h2>
            <div className="mb-4">
      ...
      case 3:
        return (
          <div>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Let's connect!12</h2>
            <div className="mb-4">
